...
class Dink_aspp(nn.Module):
    def __init__(self, num_classes=1, num_channels=3,batchsize=8):
        super(Dink_aspp, self).__init__()
        ...
        self.refine_aspp = nn.Conv2d(1280 + 256, 512, kernel_size=1, bias=False)
    ...
    def forward(self, x):
        ...
        refineaspp=self.refine_aspp(aspp)
        # Dblock = self.dblock(e4)

        # Decoder
        d4 = self.decoder4(refineaspp) + e3
