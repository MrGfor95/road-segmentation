...
class Shapecat(nn.Module):
    def __init__(self):
        ...
        self.edgeconv=nn.Sequential(nn.Conv2d(1,512,kernel_size=1),nn.ReLU(inplace=True))
...
class shapelinkplus(nn.Module):
    def __init__(self, num_classes=1,batchsize=8):
        super(shapelinkplus, self).__init__()
